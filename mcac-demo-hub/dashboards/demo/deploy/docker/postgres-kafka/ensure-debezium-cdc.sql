...
-- Run as superuser `postgres`. From dashboards/demo:
--   docker compose exec -T postgresql-primary env PGPASSWORD=postgres psql -U postgres -d demo -v ON_ERROR_STOP=1 -f - < postgres-kafka/ensure-debezium-cdc.sql
