...
|--------|-------------------|
| Dockerfile | **[`Dockerfile.repmgr`](Dockerfile.repmgr)** — repmgr + **pg_cron** / **pg_repack** / **pg_partman** built from release tarballs against Bitnami **`pg_config`**. |
